...
class Posts extends StatelessWidget {
  ...
  const Posts({
    ...
    required this.width, required this.lable, required this.option,
  });
            ...
            Padding(
              ...
              child: Row(
                ...
                children: [
                  ...
                  TextButton(
                      onPressed: () {},
                      child:option? const Text("More",
                          style: TextStyle(color: Color(0xff376AED))):
                  Row(
                    children: [
                      Assets.icons.grid.image(width: 25,height: 25),
                     SizedBox(width: 20,),
                     Assets.icons.table.image(width: 20,height: 20)
                      ...
                      Expanded(
                        child: Padding(
                          padding: EdgeInsets.fromLTRB(
                              width > 1024 ? width * 0.15 : width * 0.09,
                              0,
                                    ...
                                    onTap: () {
                                      ...
                                      BlocProvider.of<PostBloc>(context).add(
                                        LikeEvent(
                                          ...
                                          postIndex:
                                              index, // ارسال اندیس پست برای شناسایی
                                        ),
                                      );
                                    },
                                    child: Icon(
